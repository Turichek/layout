    ...
    return (
        <Box className={clsx(styles.content, revers === "revers" ? styles.revers : styles.norevers)}>
            ...
            <Box className={styles.text_container}>
                ...
                <Box sx={{my:4}}>
                    <Text size={28} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, dignissimos minus aut corporis quae alias, eum, similique doloremque tenetur modi voluptatibus vel obcaecati dolorem delectus?"} 
                    variant={'body2'} />
                </Box>
